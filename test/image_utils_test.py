...
class ImageUtilsTest(unittest.TestCase):
    ...
    def test_get_dt_from_filename(self):
        ...
        self.assertEqual("2013-09-23", ImageUtils.get_dt_from_name("video_Family_2013-09-23-09-36-45.mov")[0], "Test 1")
        self.assertEqual("2013-09-23", ImageUtils.get_dt_from_name("video_Family_2013-9-23-09-36-45.mov")[0], "Test 2")
        self.assertEqual("2013-09-03", ImageUtils.get_dt_from_name("video_Apr 4, 2014_Family_2013-9-3.mov")[0], "Test 3")
        self.assertEqual("2013-09-03", ImageUtils.get_dt_from_name("video_Family_2013-9-03.mov")[0], "Test 4")
        self.assertEqual("2013-09-03", ImageUtils.get_dt_from_name("video_222012062356045_Family_2013-09-3.mov")[0], "Test 5")
        self.assertEqual("2013-10-09", ImageUtils.get_dt_from_name("video_Family_2013-10-9.mov")[0], "Test 6")
        self.assertEqual("2013-11-23", ImageUtils.get_dt_from_name("video_Family_2013-11-23.mov")[0], "Test 7")
        self.assertEqual("2013-09-13", ImageUtils.get_dt_from_name("video_Family_2013-9-13.mov")[0], "Test 8")
        self.assertEqual("2013-09-23", ImageUtils.get_dt_from_name("video_Family_2013-09-23-09-36-45.3gp")[0], "Test 9")
        self.assertEqual(None, ImageUtils.get_dt_from_name("video_Family_10334467.3gp")[0], "Test 10")
        self.assertEqual(None, ImageUtils.get_dt_from_name("video_Family_19334467.3gp")[0], "Test 11")
        self.assertEqual("2013-06-07", ImageUtils.get_dt_from_name("video.Family.2013.06.07.mov")[0], "Test 12")
        self.assertEqual("2010-09-07", ImageUtils.get_dt_from_name("video_Family_20100907_family.mp4")[0], "Test 13")
        self.assertEqual(None, ImageUtils.get_dt_from_name("video_Family_19330907_family.mp4")[0], "Test 14")
        self.assertEqual("2003-11-12", ImageUtils.get_dt_from_name("20031112_.3gp")[0], "Test 15")
        ...
        self.assertEqual(None, ImageUtils.get_dt_from_name("Megan and Emily Visit_P5020066_1.MOV")[0], "False positive")
        self.assertEqual(None, ImageUtils.get_dt_from_name(2)[0], "Test 18")
        self.assertEqual("2010-09-07", ImageUtils.get_dt_from_name("video_Family_2010:09:07_family.mp4")[0], "Test 19")
        self.assertEqual(None, ImageUtils.get_dt_from_name("Frog")[0], "Test 20")
        self.assertEqual("2012-12-20", ImageUtils.get_dt_from_name("2002-12-08_20161112-00-20140535-4825_IMG_20121220_112808.jpg")[0], "Test 21")
